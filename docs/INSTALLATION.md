...
docker pull telemetryflow/telemetryflow-collector:1.1.8

# Or from GitHub Container Registry
docker pull ghcr.io/telemetryflow/telemetryflow-collector:1.1.8
```
...
#
# {"level":"info","msg":"Starting TelemetryFlow Collector","version":"1.1.8"}
```
...
docker run -d --name tfo-collector ... telemetryflow/telemetryflow-collector:1.1.8 ...
```
...
kubectl set image deployment/tfo-collector \
  tfo-collector=telemetryflow/telemetryflow-collector:1.1.8 \
  -n observability
...
docker stop tfo-collector
docker rm tfo-collector
docker rmi telemetryflow/telemetryflow-collector:1.1.8
```
