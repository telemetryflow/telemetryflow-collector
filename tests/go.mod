// TelemetryFlow Collector Tests
// Copyright (c) 2024-2026 TelemetryFlow. All rights reserved.

module github.com/telemetryflow/telemetryflow-collector/tests
...
require (
	...
	github.com/telemetryflow/telemetryflow-collector/components/extension/tfoauthextension v0.0.0
	github.com/telemetryflow/telemetryflow-collector/components/extension/tfoidentityextension v0.0.0
	github.com/telemetryflow/telemetryflow-collector/components/tfoexporter v0.0.0
	github.com/telemetryflow/telemetryflow-collector/components/tfootlpreceiver v0.0.0
