...
require (
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/countconnector v0.142.0 // Count signals
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/servicegraphconnector v0.142.0 // Service dependency graphs
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/spanmetricsconnector v0.142.0 // Derive metrics from traces (exemplars)
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension v0.142.0 // Health check endpoint
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/pprofextension v0.142.0 // pprof profiling
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/attributesprocessor v0.142.0 // Modify attributes
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/filterprocessor v0.142.0 // Filter telemetry
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourcedetectionprocessor v0.142.0 // Auto-detect resources
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourceprocessor v0.142.0 // Modify resources
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor v0.142.0 // Tail-based sampling
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/transformprocessor v0.142.0 // OTTL transformations
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/filelogreceiver v0.142.0 // File log receiver
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/hostmetricsreceiver v0.142.0 // Host metrics (CPU, memory, disk)
	...
	// -------------------------------------------------------------------------
	go.opentelemetry.io/collector/component v1.48.0 // Component interfaces
	go.opentelemetry.io/collector/confmap v1.48.0 // Configuration mapping
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.48.0 // File config provider
	go.opentelemetry.io/collector/confmap/provider/yamlprovider v1.48.0 // YAML config provider
	go.opentelemetry.io/collector/connector v0.142.0 // Connector interfaces
	go.opentelemetry.io/collector/connector/forwardconnector v0.142.0 // Forward connector
	go.opentelemetry.io/collector/exporter v1.48.0 // Exporter interfaces
	go.opentelemetry.io/collector/exporter/debugexporter v0.142.0 // Debug exporter
	go.opentelemetry.io/collector/exporter/otlpexporter v0.142.0 // OTLP gRPC exporter
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.142.0 // OTLP HTTP exporter
	go.opentelemetry.io/collector/extension v1.48.0 // Extension interfaces
	go.opentelemetry.io/collector/extension/zpagesextension v0.142.0 // zPages debugging
	go.opentelemetry.io/collector/otelcol v0.142.0 // Collector service
	go.opentelemetry.io/collector/processor v1.48.0 // Processor interfaces
	go.opentelemetry.io/collector/processor/batchprocessor v0.142.0 // Batch processor
