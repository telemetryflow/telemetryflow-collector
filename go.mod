...
require (
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/countconnector v0.146.0 // Count signals
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/servicegraphconnector v0.146.0 // Service dependency graphs
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/spanmetricsconnector v0.146.0 // Derive metrics from traces (exemplars)
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/fileexporter v0.146.0 // File exporter
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/prometheusexporter v0.146.0 // Prometheus scrape endpoint
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/prometheusremotewriteexporter v0.146.0 // Prometheus remote write
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/basicauthextension v0.146.0 // Basic auth
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/bearertokenauthextension v0.146.0 // Bearer token auth
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/healthcheckextension v0.146.0 // Health check endpoint
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/pprofextension v0.146.0 // pprof profiling
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/attributesprocessor v0.146.0 // Modify attributes
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/filterprocessor v0.146.0 // Filter telemetry
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourcedetectionprocessor v0.146.0 // Auto-detect resources
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourceprocessor v0.146.0 // Modify resources
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/tailsamplingprocessor v0.146.0 // Tail-based sampling
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/transformprocessor v0.146.0 // OTTL transformations
	...
	// -------------------------------------------------------------------------
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/filelogreceiver v0.146.0 // File log receiver
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/hostmetricsreceiver v0.146.0 // Host metrics (CPU, memory, disk)
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/jaegerreceiver v0.146.0 // Jaeger traces
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/prometheusreceiver v0.146.0 // Prometheus scraper
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/zipkinreceiver v0.146.0 // Zipkin traces
	...
	// -------------------------------------------------------------------------
	github.com/telemetryflow/telemetryflow-collector/components/extension/tfoauthextension v0.0.0-20260204135756-53304b885c04 // TFO auth extension
	github.com/telemetryflow/telemetryflow-collector/components/extension/tfoidentityextension v0.0.0-20260204135756-53304b885c04 // TFO identity extension
	github.com/telemetryflow/telemetryflow-collector/components/tfoexporter v0.0.0-20260204135756-53304b885c04 // TFO exporter
	github.com/telemetryflow/telemetryflow-collector/components/tfootlpreceiver v0.0.0-20260204135756-53304b885c04 // TFO OTLP receiver

	// -------------------------------------------------------------------------
	// OpenTelemetry Collector Core
	// See: https://github.com/open-telemetry/opentelemetry-collector
	// -------------------------------------------------------------------------
	go.opentelemetry.io/collector/component v1.52.0 // Component interfaces
	go.opentelemetry.io/collector/component/componenttest v0.146.1 // Component testing
	go.opentelemetry.io/collector/config/configopaque v1.52.0 // Opaque config
	go.opentelemetry.io/collector/confmap v1.52.0 // Configuration mapping
	go.opentelemetry.io/collector/confmap/provider/envprovider v1.52.0 // Env config provider
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.52.0 // File config provider
	go.opentelemetry.io/collector/confmap/provider/yamlprovider v1.52.0 // YAML config provider
	go.opentelemetry.io/collector/connector v0.146.1 // Connector interfaces
	go.opentelemetry.io/collector/connector/forwardconnector v0.146.1 // Forward connector
	go.opentelemetry.io/collector/consumer v1.52.0 // Consumer interfaces
	go.opentelemetry.io/collector/consumer/consumertest v0.146.1 // Consumer testing
	go.opentelemetry.io/collector/exporter v1.52.0 // Exporter interfaces
	go.opentelemetry.io/collector/exporter/debugexporter v0.146.1 // Debug exporter
	go.opentelemetry.io/collector/exporter/exportertest v0.146.1 // Exporter testing
	go.opentelemetry.io/collector/exporter/nopexporter v0.146.1 // Nop exporter
	go.opentelemetry.io/collector/exporter/otlpexporter v0.146.1 // OTLP gRPC exporter
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.146.1 // OTLP HTTP exporter
	go.opentelemetry.io/collector/extension v1.52.0 // Extension interfaces
	go.opentelemetry.io/collector/extension/extensiontest v0.146.1 // Extension testing
	go.opentelemetry.io/collector/extension/zpagesextension v0.146.1 // zPages debugging
	go.opentelemetry.io/collector/otelcol v0.146.1 // Collector service
	go.opentelemetry.io/collector/pdata v1.52.0 // Protocol data
	go.opentelemetry.io/collector/processor v1.52.0 // Processor interfaces
	go.opentelemetry.io/collector/processor/batchprocessor v0.146.1 // Batch processor
	go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.146.1 // Memory limiter
	go.opentelemetry.io/collector/receiver v1.52.0 // Receiver interfaces
	go.opentelemetry.io/collector/receiver/otlpreceiver v0.146.1 // OTLP receiver
	go.opentelemetry.io/collector/receiver/receivertest v0.146.1 // Receiver testing
	go.opentelemetry.io/collector/service v0.146.1 // Collector service
)
